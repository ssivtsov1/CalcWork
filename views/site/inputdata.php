...
// window.onload=function(){
        ...
        $(".field-inputdataform-verification").hide();
...
<script>
    ...
    function f_calc(n) {
        if (n == 2) {
            $(".field-inputdataform-verification").show();
            localStorage.setItem('type_calc','ind');
        } else {
            $(".field-inputdataform-verification").hide();
            localStorage.setItem('type_calc','type');
        }
    }
...
//                    punct = punct.substr(0,pos);
            ...
            dropDownList(ArrayHelper::map(
                app\models\spr_costwork::findbysql('Select min(id) as id,usluga from costwork
                ...
                [
                    ...
                    function(data) {
                         var flag=0,fl=0,verification=0;
                         var type_usl = localStorage.getItem("type_calc"); 
...
//                         alert($(this).val());
                         ...
                         if((+n==215) || (+n==663) || (+n==707) || (+n==756) || (+n==1537)) flag=1; // Транспортні послуги
                         if((+n>=584) && (+n<591)) flag=1; // Транспортні послуги
                          if((+n>=816) && (+n<836)) flag=1; // Транспортні послуги
...
//                         alert(n);
//                         alert(flag);
                        if(+n==140 && type_usl=="ind") verification=1;
                        } 
                         if(geo_marker!="")
