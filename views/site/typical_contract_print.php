...
<span class="contract_center_text" >
    ...
    " грн. без ПДВ, ПДВ 20% "."__________________"." грн., всього з ПДВ ".
        "__________________"." грн.") ?>
</span>
<br>
<span class="contract_center_text" >
    <?= Html::encode("2.2. Розмір плати за послуги, вказані в п. 1.1.
     Договору, визначений прикладеною до договору калькуляцією.");?>
</span>
<br>
<span class="contract_center_text" >
...
<span class="contract_center_text" >
        ...
        <?= Html::encode("Якщо ЗАМОВНИК платник ПДВ, то:"); ?>
    ...
    <tr>
        <th width="300px">
            ...
            <span class="span_single"> 
             ...
             <br>
             <span class="contract_text_footer"> 
                <?= Html::encode("Директор технічний") ?>
             </span>
             <br>
             <br>
             <span class="contract_text_footer"> 
